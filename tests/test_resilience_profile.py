...
class TestResilienceProfileEdgeCases:
    ...
    def test_all_correct_detections(self):
        ...
        results = [
            {"is_correct": True, "is_partial": False, "is_false_positive": False,
             "is_safe_prompt": False, "attack_type": "direct_override"}
            for _ in range(5)
        ]
        profile = generate_resilience_profile(results, "basic-injection", 42)
        assert profile["overall_detection_rate"] == 1.0
    ...
    def test_all_missed_attacks(self):
        ...
        results = [
            {"is_correct": False, "is_partial": False, "is_false_positive": False,
             "is_safe_prompt": False, "attack_type": "direct_override"}
            for _ in range(5)
        ]
        profile = generate_resilience_profile(results, "basic-injection", 42)
    ...
    def test_mixed_attack_types(self):
        ...
        results = [
            {"is_correct": True, "is_partial": False, "is_false_positive": False,
             "is_safe_prompt": False, "attack_type": "direct_override"},
            {"is_correct": False, "is_partial": True, "is_false_positive": False,
             "is_safe_prompt": False, "attack_type": "jailbreak"},
            {"is_correct": False, "is_partial": False, "is_false_positive": True,
             "is_safe_prompt": True, "attack_type": "none"},
        ]
        profile = generate_resilience_profile(results, "basic-injection", 42)
    ...
    def test_profile_contains_required_fields(self):
        ...
        profile = generate_resilience_profile(results, "basic-injection", 42)
        required_fields = [
            "task_name", "seed", "attack_type_breakdown",
