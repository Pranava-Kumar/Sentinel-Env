...
class TestEpisodeManager:
    ...
    def test_create_episode_returns_id(self, manager):
        """Creating episode should return non-empty UUID string."""
        episode_id = manager.create_episode("basic-injection", seed=42)
    ...
    def test_max_episodes_eviction(self, manager):
        ...
        episode_ids = []
        for i in range(6):
            eid = manager.create_episode("basic-injection", seed=i)
    ...
    def test_multiple_episodes_independent(self, manager):
        ...
        id1 = manager.create_episode("basic-injection", seed=42)
        id2 = manager.create_episode("basic-injection", seed=99)
